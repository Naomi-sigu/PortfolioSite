    ...
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="fade-in">
          <p className="text-lg text-muted-foreground mb-4" data-testid="hero-greeting">
            Hello, I'm
          </p>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6" data-testid="hero-name">
            Atul Kushwaha
          </h1>
          <h2 className="text-2xl md:text-3xl text-primary mb-8 font-medium" data-testid="hero-title">
            Computer Science Undergraduate
          </h2>
          <p className="text-xl text-gray-200 mb-12 max-w-2xl mx-auto leading-relaxed" data-testid="hero-description">
